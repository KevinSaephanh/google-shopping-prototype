...
const AccordionItem: React.FC<AccordionItemProps> = ({
  ...
  return (
    <div
      className={`border border-gray-700 rounded-lg bg-gray-800 transition-colors duration-300 ${isOpen ? "ring-1 ring-purple-500" : ""}`}
    >
      ...
      >
        ...
        <div className="flex items-center">
          ...
          {!isOpen && summaryContent && (
            <span className="text-sm text-gray-400 mr-4">{summaryContent}</span>
          )}
