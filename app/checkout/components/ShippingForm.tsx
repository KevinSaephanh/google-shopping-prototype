...
const ShippingForm: React.FC<ShippingFormProps> = ({ initialData, onSave, onCancel }) => {
    ...
    return (
        <div className="space-y-4 pt-2">
            <div>
                <label className="block text-sm font-medium text-gray-400 mb-1" htmlFor="name">Full Name</label>
                <input
                    type="text"
                    id="name"
                    name="name"
